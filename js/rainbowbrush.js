...
var canvas = void 0,
    ...
    rainbow = true;
var body = void 0,
    backgroundColorInput = void 0,
    brushColorInput = void 0,
    rainbowBrushInput = void 0,
    gravityInput = void 0,
    flowInput = void 0,
    clearButton = void 0;
var width = void 0,
...
var V2 = function () {
    ...
    _createClass(V2, [{
        ...
        key: 'mult',
        value: function mult(multiplier) {
            this.x *= multiplier;
            this.y *= multiplier;
            return this;
        }
